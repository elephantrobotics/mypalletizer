...
from .generate import CommandGenerater
from .common import Command


class MyPalletizer(CommandGenerater):
    """MyPalletizer Python API Serial communication class.

    Supported methods:

        # Overall status
            Look at parent class: `CommandGenerater`.
        ...
        # MDI mode and operation
            ...
            sync_send_angles() *
            sync_send_coords() *
            Other look at parent class: `CommandGenerater`.
